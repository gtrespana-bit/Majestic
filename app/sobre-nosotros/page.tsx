      ...
      <section className="bg-[hsl(var(--card))/0.2] border border-[hsl(var(--border))] rounded-2xl p-8 md:p-12">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <Link href="/contacto"><button className="mt-6 px-6 py-3 rounded-lg bg-[hsl(var(--primary))] text-[hsl(var(--primary-fg))] hover:bg-[hsl(var(--primary))/0.9] font-semibold transition-all">Ver detalles del proceso <ArrowRight className="inline ml-2 w-4 h-4" /></button></Link>
          </div>
